function(get_version)
  file(READ "${CMAKE_CURRENT_LIST_DIR}/include/hackerchat/version.hpp" file_contents)
  ...
  set(HACKERCHAT_VERSION_MAJOR
      ${ver_major}
      PARENT_SCOPE
  )
  set(HACKERCHAT_VERSION_MINOR
      ${ver_minor}
      PARENT_SCOPE
  )
  set(HACKERCHAT_VERSION_PATCH
      ${ver_patch}
      PARENT_SCOPE
  )

  set(HACKERCHAT_VERSION
